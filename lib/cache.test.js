...
test('GOOD: Register cache with singleflight, call api only once', async () => {
  ...
  instance.register('Videos', () => singleflight.Do('T1', getVideo))
...
test('Expired', async () => {
  ...
  let instance = getNewInstance()
  instance.register('Videos', () => singleflight.Do('T2', getVideo))
...
test('Custom ttl', async () => {
  apiTimes = 0
  let instance = getNewInstance()
  instance.register('Videos', () => singleflight.Do('T3', getVideo), 30)
  let d = await instance.get('Videos')
  await instance.get('Videos')
  await instance.get('Videos')
  await sleep(TTL)
